...
@SpringBootTest(classes = {IntegrationEnvironment.EnvironmentConfig.class, JdbcTemplateChatRepository.class})
public class JdbcChatTestIT extends IntegrationEnvironment {
